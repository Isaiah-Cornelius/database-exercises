...
UPDATE albums
    SET sales = sales * 10;
SELECT 'All albums in your table.' AS 'VERIFY Update Exercises 3a';
SELECT * FROM albums;
...
SELECT 'All albums by Michael Jackson' AS 'Update Exercises 2c';
SELECT * FROM albums WHERE artist = 'Michael Jackson';
SELECT 'Change ''Michael Jackson'' to ''Peter Jackson''' AS 'Update Exercises 3c';
UPDATE albums
